...
date: 2024-12-07
tags: ["xampp", "mysql", "installation"]
published: true
img: "/images/blogs/xampp/install-xampp.jpg"
---
...
1. Download file installer XAMPP dari website resmi [www.apachefriends.org](https://www.apachefriends.org/). Pilih yang versi terbaru **XAMPP for Windows**.
   <Image src="/images/blogs/xampp/langkah-1.png" width="718" height="304" alt="Langkah 1" />
...
3. Pilih komponen yang ingin diinstal, seperti Apache, MySQL, dan PHP lalu klik Next untuk melanjutkan.
   <Image src="/images/blogs/xampp/langkah-2.png" width="420" height="304" alt="Langkah 1" />
4. Tentukan lokasi penginstalan (defaultnya adalah C:\xampp), lalu klik Next untuk melanjutkan.
   <Image src="/images/blogs/xampp/langkah-3.png" width="420" height="304" alt="Langkah 1" />
...
6. Jalankan Apache dan MySQL melalui XAMPP Control Panel.
   <Image src="/images/blogs/xampp/langkah-4.png" width="420" height="304" alt="Langkah 1" />
