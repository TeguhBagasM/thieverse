...
Setelah selesai tekan CTRL + S untuk simpan perubahan, Jika tidak ada error atau proses instalasi selesai, masuk ke folder proyek dan jalankan server bawaan Laravel:
