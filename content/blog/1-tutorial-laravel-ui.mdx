---
title: "Part: 1 Tutorial Laravel UI"
description: "Langkah-Langkah Tutorial Laravel Laravel UI"
date: 2025-06-19
tags: ["laravel"]
published: true
...
```bash
composer create-project --prefer-dist laravel/laravel:^12 laravel-ui
```
