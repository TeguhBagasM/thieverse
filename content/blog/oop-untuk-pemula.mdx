...
Encapsulation (Enkapsulasi): Proses menyembunyikan detail internal dari sebuah objek, sehingga pengguna objek tersebut hanya dapat berinteraksi dengan fungsi atau metode tertentu. Ini seperti menggunakan remote TV: Anda tidak perlu tahu cara kerja internal TV, cukup tekan tombol untuk mengubah saluran.
