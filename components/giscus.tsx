...
export function Comments() {
  ...
  useEffect(() => {
    const updateTheme = () => {
      ...
      script.setAttribute("data-repo", "TeguhBagasM/blog");
      script.setAttribute("data-repo-id", "R_kgDOM1VljA");
      ...
      script.setAttribute("data-theme", effectiveTheme === "dark" ? "dark" : "light");
